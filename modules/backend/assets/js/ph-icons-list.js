oc.Modules.register('backend.phosphor-icon-list', function () {
    return {
        ...
        "ph ph-scroll": "Scroll",
        "ph ph-seal:before,": ".ph.ph-circle-wavy  Seal:before, .ph.ph Circle Wavy",
        "ph ph-seal-check:before,": ".ph.ph-circle-wavy-check  Seal Check:before, .ph.ph Circle Wavy Check",
        "ph ph-seal-question:before,": ".ph.ph-circle-wavy-question    Seal Question:before, .ph.ph Circle Wavy Question",
        "ph ph-seal-warning:before,": ".ph.ph-circle-wavy-warning  Seal Warning:before, .ph.ph Circle Wavy Warning",
        ...
        "ph ph-text-b:before,": ".ph.ph-text-bolder    Text B:before, .ph.ph Text Bolder",
