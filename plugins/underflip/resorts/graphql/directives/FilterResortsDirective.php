...
SDL;
    ...
    protected function orderByType(Builder &$query, array $orderBy): void
    {
        ...
        // Assuming 'underflip_resorts_resorts.id' is unique, and aiming to avoid duplicates
        $query
            ...
            // Group by the main table's primary key to safeguard against ONLY_FULL_GROUP_BY issues
            ->groupBy('underflip_resorts_resorts.id');
    }
