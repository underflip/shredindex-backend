...
class ComposerAutoloaderInit02b791b67b928853969b061eb6816088
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit02b791b67b928853969b061eb6816088::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire02b791b67b928853969b061eb6816088($fileIdentifier, $file);
        }
...
function composerRequire02b791b67b928853969b061eb6816088($fileIdentifier, $file)
{
